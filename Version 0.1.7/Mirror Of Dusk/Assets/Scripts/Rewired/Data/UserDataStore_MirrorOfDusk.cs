...
{
    public class UserDataStore_MirrorOfDusk : UserDataStore
    {
        ...
        [SerializeField] private string playerPrefsKeyPrefix = "RewiredSaveData";
        ...
        protected override void OnControllerConnected(ControllerStatusChangedEventArgs args)
        {
            ...
            if (args.controllerType == (ControllerType)2)
            {
        ...
        private int LoadPlayerDataNow(Player player)
        {
            ...
            num += this.LoadControllerMaps(player.id, (ControllerType)0, 0);
            num += this.LoadControllerMaps(player.id, (ControllerType)1, 0);
            foreach (Joystick joystick in player.controllers.Joysticks)
            {
                num += this.LoadControllerMaps(player.id, (ControllerType)2, joystick.id);
            }
            return num;
        }
        ...
        private int LoadJoystickData(int joystickId)
        {
            ...
            for (int i = 0; i < allPlayers.Count; i++)
            {
                ...
                if (player.controllers.ContainsController((ControllerType)2, joystickId))
                {
                    num += this.LoadControllerMaps(player.id, (ControllerType)2, joystickId);
                }
            }
        ...
        private int LoadControllerMaps(int playerId, ControllerType controllerType, int controllerId)
        {
            ...
            {
                if (controllerType == ControllerType.Keyboard && (playerId == 0 || playerId == 1))
                {
        ...
        private void SaveJoystickData(int joystickId)
        {
            ...
            for (int i = 0; i < allPlayers.Count; i++)
            {
                ...
                if (player.controllers.ContainsController((ControllerType)2, joystickId))
                {
                    this.SaveControllerMaps(player.id, (ControllerType)2, joystickId);
                }
            }
