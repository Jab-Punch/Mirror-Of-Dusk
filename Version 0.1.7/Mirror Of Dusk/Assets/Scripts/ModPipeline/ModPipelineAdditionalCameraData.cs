...
namespace UnityEngine.Experimental.Rendering.ModPipeline
{
    ...
    public class ModPipelineAdditionalCameraData : MonoBehaviour, ISerializationCallbackReceiver
    {
        ...
        public bool requiresDepthTexture
        {
            get
            {
                ...
                {
                    ModPipelineAsset asset = GraphicsSettings.renderPipelineAsset as ModPipelineAsset;
