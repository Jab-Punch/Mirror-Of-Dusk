...
namespace UnityEngine.Experimental.Rendering.ModPipeline
{
    ...
    [CreateAssetMenu(menuName = "Rendering/MirrorOfDusk Pipeline")]
    public class ModPipelineAsset : RenderPipelineAsset, ISerializationCallbackReceiver
    {
        Shader m_DefaultShader;

        // Default values set when a new ModPipeline asset is created
        ...
        [SerializeField] ModPipelineResources m_ResourcesAsset = null;
        ...
        */
        ...
        static readonly string s_SearchPathPackage = "Assets/Scripts/ModPipeline";
        /*
        ...
        [MenuItem("Assets/Create/Rendering/Mod Pipeline Resources", priority = CoreUtils.assetCreateMenuPriority1)]
        static void CreateModPipelineResources()
        {
            var instance = CreateInstance<ModPipelineResources>();
            AssetDatabase.CreateAsset(instance, string.Format("Assets/{0}.asset", typeof(ModPipelineResources).Name));
        }
        ...
        static T LoadResourceFile<T>() where T : ScriptableObject
        {
            ...
            if (resourceAsset == null)
            {
                string path = s_SearchPathPackage + "/Data/" + typeof(T).Name + ".asset";
                resourceAsset = AssetDatabase.LoadAssetAtPath<T>(path);
            }
        ...
        ModPipelineResources resources
        {
            get
            {
#if UNITY_EDITOR
                if (m_ResourcesAsset == null)
                    m_ResourcesAsset = LoadResourceFile<ModPipelineResources>();
#endif
        ...
        {
            get { return resources != null ? resources.hsbShader : null; }
        }
