...
namespace UnityEngine.Experimental.Rendering.ModPipeline
{
    public sealed class ScriptableRenderer
    {
        ...
        public ScriptableRenderer(ModPipelineAsset pipelineAsset)
        {
            ...
            m_Materials = new[]
            {
                ...
                CoreUtils.CreateEngineMaterial(pipelineAsset.hsbShader),
            };
        ...
        public static bool RequiresIntermediateColorTexture(ref CameraData cameraData, RenderTextureDescriptor baseDescriptor)
        {
            ...
            bool isScaledRender = !Mathf.Approximately(1.0f, 1.0f);
            ...
            return noAutoResolveMsaa || cameraData.isSceneViewCamera || isScaledRender || 
                cameraData.postProcessEnabled || cameraData.requiresOpaqueTexture || isTargetTexture2DArray || !cameraData.isDefaultViewport;
        }
