...
public class MenuSelectArrowUp : MonoBehaviour {

    public bool summonInstant = true;
    SpriteRenderer spr;
    public Sprite arrowOn;
    public Sprite arrowOff;
    IMenuSelectArrowUp menuSelectArrowUpGroup;
    ...
    void Start()
    {
        menuSelectArrowUpGroup = gameObject.transform.parent.GetComponent<IMenuSelectArrowUp>();
        if (!summonInstant)
        {
    ...
    {
        menuSelectArrowUpGroup.removeMenuSelectArrowUp();
        Destroy(gameObject);
    }
}
